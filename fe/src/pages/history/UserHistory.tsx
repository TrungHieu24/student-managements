...
const UserHistory: React.FC = () => {
  ...
  const fetchHistory = async () => {
    try {
      ...
      setHistory(sanitizedData); // Use sanitizedData directly
  ...
  const renderJsonField = (data: any) => {
    ...
    try {
      ...
      return (
        <div style={{
          padding: '8px',
          backgroundColor: '#4a4d5e', // Darker background for the JSON info boxes
          borderRadius: '4px',
          fontSize: '13px',
          maxWidth: '300px',
          overflow: 'auto',
        ...
        <TextField
            ...
            endAdornment: (
              <InputAdornment position="end">
                <IconButton
                  ...
                  edge="end"
                  sx={{ color: '#fff' }} // Password visibility icon color
                >
          ...
          sx={{
            '& .MuiOutlinedInput-root': {
              backgroundColor: '#4a4d5e', // Darker background for password field
              color: '#fff', // Text color
              '& fieldset': { borderColor: '#666' }, // Border color
              '&:hover fieldset': { borderColor: '#888' }, // Hover border color
              '&.Mui-focused fieldset': { borderColor: '#fff' }, // Focused border color
            },
                ...
                history.map((record) => (
                  <TableRow
                    ...
                    sx={{
                      ...
                      '&:hover': { backgroundColor: '#4c4f64 !important' } // Hover effect
                    }}
                  >
